...
class ParametersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parameter" do
    assert_difference('Parameter.count') do
      post parameters_url, params: { parameter: { alias: @parameter.alias, description: @parameter.description, name: @parameter.name, slug: @parameter.slug, value: @parameter.value, values: @parameter.values } }
    end
  ...
  test "should update parameter" do
    patch parameter_url(@parameter), params: { parameter: { alias: @parameter.alias, description: @parameter.description, name: @parameter.name, slug: @parameter.slug, value: @parameter.value, values: @parameter.values } }
